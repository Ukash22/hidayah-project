            ...
            <div className="container pt-32 pb-20">
                <div className="max-w-md mx-auto bg-white rounded-card-lg shadow-2xl p-10 border border-slate-100 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <div className="text-center mb-10">
                        <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary mx-auto mb-6 text-2xl font-bold shadow-inner">🔑</div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-[11px] font-semibold uppercase tracking-wide mb-2 text-primary ml-1">New Password</label>
                            <input
                                type="password"
                                value={password}
                        ...
                        <div>
                            <label className="block text-[11px] font-semibold uppercase tracking-wide mb-2 text-primary ml-1">Confirm Password</label>
                            <input
                                type="password"
