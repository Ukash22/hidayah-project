...
export default function TutorMaterials() {
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-card-lg border border-slate-100 dark:border-slate-800 shadow-sm p-10 mb-12">
                <form className="grid md:grid-cols-2 gap-8" onSubmit={handleUpload}>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="w-full px-6 py-4 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 max-h-40 overflow-y-auto space-y-3">
                            <label className="flex items-center gap-3 cursor-pointer">
                                ...
                                />
                                <span className="text-[11px] font-bold text-primary uppercase tracking-widest">Global Broadcast</span>
                            </label>
                    ...
                    <div className="flex items-end">
                        <button disabled={uploading} type="submit" className="w-full bg-primary text-white py-5 rounded-2xl font-bold uppercase tracking-[0.2em] text-xs shadow-2xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-3">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 flex items-center gap-3 px-2 mb-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {materials.length > 0 ? materials.map(mat => (
                    <div key={mat.id} className="bg-white dark:bg-slate-900 p-8 rounded-card-lg border border-slate-100 dark:border-slate-800 hover:border-primary/20 transition-all group relative overflow-hidden shadow-sm">
                        ...
                        <div className="flex flex-col h-full">
                            <div className="w-14 h-14 bg-primary-soft rounded-2xl flex items-center justify-center text-2xl mb-6 border border-blue-100 group-hover:scale-110 transition-transform">
                    ...
                    <div className="col-span-full py-24 text-center bg-slate-50 dark:bg-slate-800/60 rounded-card-lg border border-dashed border-slate-200 dark:border-slate-700">
