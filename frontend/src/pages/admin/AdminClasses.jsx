        ...
        <>
            ...
            <div className="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-2xl w-fit mb-6 gap-1">
                <button
                    ...
                    className={`px-5 py-2 rounded-xl text-[11px] font-semibold uppercase tracking-wide transition-all ${view === 'regular' ? 'bg-white dark:bg-slate-900 shadow-sm text-slate-900 dark:text-slate-100' : 'text-slate-500 hover:text-slate-600'}`}
                >
                    Regular Classes ({regularClasses.length})
                </button>
                <button
                    onClick={() => setView('trials')}
                    className={`px-5 py-2 rounded-xl text-[11px] font-semibold uppercase tracking-wide transition-all ${view === 'trials' ? 'bg-white dark:bg-slate-900 shadow-sm text-slate-900 dark:text-slate-100' : 'text-slate-500 hover:text-slate-600'}`}
                >
