            ...
            <div className="container px-4">
                <div className="grid lg:grid-cols-5 gap-12 items-center">
                    <div className="lg:col-span-2 space-y-8">
                        <div>
                            <span className="text-secondary font-bold tracking-widest uppercase text-xs mb-3 block">Join our Global Community</span>
                            <h2 className="text-3xl md:text-5xl font-display text-primary leading-tight mb-6">Start Your Journey Today</h2>
                    ...
                    <div className="lg:col-span-3">
                        <div className="bg-white p-10 rounded-card-lg shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100 relative group overflow-hidden">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label htmlFor="firstName" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">First Name *</label>
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="lastName" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Last Name</label>
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Email *</label>
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="phone" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Phone</label>
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <label htmlFor="country" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Country</label>
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="courseInterested" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Focus Course</label>
                                ...
                                <div className="grid grid-cols-3 gap-6 pt-2">
                                    <div className="space-y-2">
                                        <label htmlFor="preferredDay" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Pref. Day</label>
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="preferredTime" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1">Slot</label>
                                    ...
                                    <div className="space-y-2">
                                        <label htmlFor="preferredTimeExact" className="text-[11px] font-bold text-slate-500 uppercase tracking-widest ml-1 italic text-primary">Exact Time</label>
                                        <input id="preferredTimeExact"
                                            ...
                                            className="w-full px-4 py-3 rounded-xl border-2 border-primary/10 bg-primary/5 focus:bg-white focus:border-primary outline-none transition-all font-bold text-primary text-xs text-center placeholder:text-primary/30"
                                        />
                                    </div>
                                </div>
                                ...
                                {status.message && (
                                    <div className={`mt-6 p-4 rounded-2xl text-center text-xs font-bold animate-in fade-in slide-in-from-bottom-2 ${status.type === 'success' ? 'bg-green-50 text-green-600 border border-green-100' : status.type === 'error' ? 'bg-red-50 text-red-600 border border-red-100' : 'bg-primary-soft text-primary border border-blue-100'}`}>
                                        {status.message}
                                    </div>
                                )}
                            </form>
